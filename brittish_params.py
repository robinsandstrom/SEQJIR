...
s_1 = 1 / 4 # 1 / Antalet dagar tills tillfrisknad som infective
s_2 = 1 / 6.2 # 1 / Antalet dagar att tillfriskna som isolerad

k_1 = 1 / 5 # 1 / Antalet dagar få från exponerad till infective (inkubationstid)
k_2 = 1 / 8 # 1 / Antalet dagar från karantän till isolerad

d_1 = 0.0 #  Dödlighet i infective
d_2 = 0.0022 #  Dödlighet i isolated
