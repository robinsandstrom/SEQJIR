...
e_Q = 0 # Smittsamhet för karantänade
e_J = 0.82 # Smittsamhet för isolerade
g_1 = 1 / 10 # 1/ Antalet dagar gå från exposed till quarantined
g_2 = 1 / 2 # 1/ Antalet dagar gå från infective till isolated (J)
s_1 = 1 / 14 # 1 / Antalet dagar tills tillfrisknad som infective
s_2 = 1 / 14 # 1 / Antalet dagar att tillfriskna som isolerad
